...
/**
 * @brief Moves data from src pointer to dst pointer.
 *
...
/**
 * @brief Sets data of memory src pointer to value.
 *
...
/**
 * @brief Sets data of memory src pointer to 0.
 *
...
/**
 * @brief Reverse data of array.
 *
 * This should take a pointer to a memory location and
...
/**
 * @brief Allocate words in dynamin memory
 * 
 ...
 * @param len length of data.
 *
 * @return int32_t* pointer to memory OR NULL.
 */
